...
/* harmony import */ var _project_project_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./project/project.component */ "./src/app/project/project.component.ts");
/* harmony import */ var _project_project_list_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./project/project-list.component */ "./src/app/project/project-list.component.ts");
/* harmony import */ var _issue_issue_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./issue/issue.component */ "./src/app/issue/issue.component.ts");
/* harmony import */ var _issue_issuelist_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./issue/issuelist.component */ "./src/app/issue/issuelist.component.ts");
...
var routes = [
    ...
    {
        path: 'project',
        component: _project_project_component__WEBPACK_IMPORTED_MODULE_36__["ProjectComponent"]
    },
    {
        path: "projectlist",
        component: _project_project_list_component__WEBPACK_IMPORTED_MODULE_37__["ProjectListComponent"]
    },
    {
        path: 'project/:id',
        component: _project_project_component__WEBPACK_IMPORTED_MODULE_36__["ProjectComponent"]
    ...
    {
        path: 'issue',
        component: _issue_issue_component__WEBPACK_IMPORTED_MODULE_38__["IssueComponent"]
    },
    {
        path: 'issuelist',
        component: _issue_issuelist_component__WEBPACK_IMPORTED_MODULE_39__["IssuelistComponent"]
    },
    {
        path: 'issue/:id',
        component: _issue_issue_component__WEBPACK_IMPORTED_MODULE_38__["IssueComponent"]
...
/* harmony import */ var _project_project_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./project/project.component */ "./src/app/project/project.component.ts");
/* harmony import */ var _project_project_list_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./project/project-list.component */ "./src/app/project/project-list.component.ts");
/* harmony import */ var _issue_issue_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./issue/issue.component */ "./src/app/issue/issue.component.ts");
/* harmony import */ var _issue_issuelist_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./issue/issuelist.component */ "./src/app/issue/issuelist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _project_project_component__WEBPACK_IMPORTED_MODULE_48__["ProjectComponent"],
                _project_project_list_component__WEBPACK_IMPORTED_MODULE_49__["ProjectListComponent"],
                _issue_issue_component__WEBPACK_IMPORTED_MODULE_50__["IssueComponent"],
                _issue_issuelist_component__WEBPACK_IMPORTED_MODULE_51__["IssuelistComponent"],
            ],
            imports: [
...
var IssueComponent = /** @class */ (function (_super) {
    ...
    function IssueComponent(locator, route) {
    ...
    IssueComponent.prototype.limitInput = function (event, maxLength) {
...
var IssuelistComponent = /** @class */ (function (_super) {
    ...
    function IssuelistComponent(locator, route, httpClient) {
        ...
        _this.isValidversionInput = true; // Property to track validity of cost input
        _this.isValidnameInput = true; // Property to track validity of description input
        return _this;
    }
...
/***/ "./src/app/project/project-list.component.css":
/*!****************************************************!*\
  !*** ./src/app/project/project-list.component.css ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Byb2plY3QvcHJvamVjdC1saXN0LmNvbXBvbmVudC5jc3MifQ== */"
...
module.exports = "html------------------------------------------------\n<app-navbar></app-navbar>\n\n<style>\n  #nnn {\n    background: none;\n    border: none;\n    cursor: pointer;\n  }\n\n  .panel-heading {\n    height: 50px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  .search-inputs {\n    margin-top: 20px;\n  }\n\n  .search-inputs .form-control,\n  .search-inputs .btn {\n    margin-bottom: 10px;\n  }\n\n  .content-wrapper {\n    background: url('assets/files/1024.jpg') no-repeat center center;\n    background-attachment: fixed;\n    background-size: cover;\n    width: auto;\n    height: 105vh;\n    padding: 20px;\n  }\n\n  .table-responsive {\n    margin-top: 20px;\n  }\n\n  .search-inputs .col-sm-2,\n  .search-inputs .col-sm-1 {\n    padding: 0 5px;\n  }\n</style>\n\n<div class=\"content-wrapper\">\n  <div class=\"container-fluid\">\n    <div class=\"panel panel-primary\">\n      <div class=\"panel-heading\">\n        <h1 class=\"text-primary font-weight-bold\">{{ 'Project List' | translate }}</h1>\n      </div>\n\n      <div class=\"row search-inputs p-1 justify-content-center\">\n        <div class=\"col-sm-2\">\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.name\"\n            placeholder=\"{{ 'Search Name' | translate }}\" maxlength=\"200\" pattern=\"[A-Za-z\\s]*\"\n            (input)=\"validateInput($event, 'name')\">\n          <div *ngIf=\"!isValidnameInput\" class=\"text-danger\">\n            Please enter letters and spaces only.\n          </div>\n        </div>\n\n        <div class=\"col-sm-2\">\n          <input type=\"date\" class=\"form-control\" [(ngModel)]=\"form.searchParams.openDate\"\n            placeholder=\"{{ 'Search openDate' | translate }}\">\n        </div>\n\n        <div class=\"col-sm-2\">\n          <input type=\"number\" class=\"form-control\" [(ngModel)]=\"form.searchParams.version\"\n            placeholder=\"{{ 'Search Version' | translate }}\" maxlength=\"2\" pattern=\"[a-zA-Z0-9\\s]*\"\n            (input)=\"validateInput($event, 'version')\">\n          <div *ngIf=\"!isValidversionInput\" class=\"text-danger\">\n            Please enter letters, numbers, and spaces only.\n          </div>\n        </div>\n\n        <div class=\"col-sm-2\">\n          <select class=\"form-control\" name=\"category\" [(ngModel)]=\"form.searchParams.category\" aria-label=\"ngSelected\">\n            <option [ngValue]=\"\" value=\"undefined\">{{' Select Category' | translate }}</option>\n            <option *ngFor=\"let obj of form.preload.projectlist\" [value]=\"obj\">{{obj}}</option>\n          </select>\n        </div>\n\n\n        <div class=\"col-sm-1\">\n          <button (click)=\"submit()\" class=\"btn btn-primary\">{{ 'Search' | translate }}</button>\n        </div>\n\n        <div class=\"col-sm-2\">\n          <button (click)=\"forward('/project')\" type=\"button\" class=\"btn btn-success\">\n            {{ 'Add Project' | translate }}\n          </button>\n        </div>\n\n        <div class=\"col-sm-1\">\n          <button (click)=\"deleteMany()\" class=\"btn btn-danger\">{{ 'Delete' | translate }}</button>\n        </div>\n      </div>\n\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n        {{ form.message }}`````\n      </div>\n\n      <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n        {{ form.message }}\n      </div>\n\n      <div class=\"table-responsive\">\n        <table class=\"table table-bordered table-hover font-weight-bold text-dark\">\n          <thead class=\"thead-dark text-uppercase\">\n            <tr align=\"center\">\n              <th><input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" name=\"list_name\"\n                  (change)=\"checkUncheckAll($event)\" /></th>\n              <th>{{ 'S.No' | translate }}</th>\n              <th>{{ 'NAME' | translate }}</th>\n              <th>{{ 'OPENDATE' | translate }}</th>\n              <th>{{ 'VERSION' | translate }}</th>\n              <th>{{ 'CATEGORY' | translate }}</th>\n              <th>{{ 'Edit' | translate }}</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\n              <td><input type=\"checkbox\" #checkboxes (change)=\"checklistUpdate()\" name=\"list_name\" [id]=\"m.id\" />\n              </td>\n              <td>{{ (form.pageNo * 5) + i + 1 }}</td>\n              <td>{{ m.name }}</td>\n              <td>{{ m.openDate | date:'dd-MM-yyyy' }}</td>\n              <td>{{ m.version }}</td>\n              <td>{{ m.category }}</td>\n\n              <td>\n                <button class=\"fa fa-edit text-primary\" id=\"nnn\" (click)=\"forward('/project/' + m.id)\">\n                </button>\n              </td>\n            </tr>\n          </tbody>\n        </table>\n\n        <div class=\"d-flex justify-content-between mt-3\">\n          <button (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\">{{ 'Previous' | translate }}\n          </button>\n          <div *ngIf=\"form.list.length == 0\">\n            <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/projectlist']\" (click)=\"exit()\">\n              {{ 'Back' | translate }}\n            </a>\n          </div>\n          <button (click)=\"next()\" [disabled]=\"nextList == 0\" class=\"btn btn-info\">{{ 'Next' | translate }}</button>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<app-footer></app-footer>\n"

/***/ }),

/***/ "./src/app/project/project-list.component.ts":
/*!***************************************************!*\
  !*** ./src/app/project/project-list.component.ts ***!
  \***************************************************/
...
var ProjectListComponent = /** @class */ (function (_super) {
    ...
    ProjectListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./project-list.component.html */ "./src/app/project/project-list.component.html"),
            styles: [__webpack_require__(/*! ./project-list.component.css */ "./src/app/project/project-list.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])
...
var ProjectComponent = /** @class */ (function (_super) {
    ...
    function ProjectComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.PROJECT, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
    ...
    ProjectComponent.prototype.limitInput = function (event, maxLength) {
        var target = event.target;
        var value = target.value;
        if (value.length >= maxLength) {
            event.preventDefault();
...
module.exports = __webpack_require__(/*! C:\rays software\hardeep\proect10_FrontCtl-main\ORSProject10-UIFctl\src\main.ts */"./src/main.ts");
